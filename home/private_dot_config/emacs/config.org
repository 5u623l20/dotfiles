...
*** Zooming In and Out
You can use the bindings CTRL plus =/- for zooming in/out. These functions
provide something close to text-scale-mode, but for every buffer, including
the minibuffer and mode line.
